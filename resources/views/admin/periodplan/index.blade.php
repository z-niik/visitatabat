            ...
            <div class="col-12">
                <div class="toolbar-ui">
                    ...
                    <ul class="breadcrumb-ui ps-0">
                        <li><a href="index.html" title="پیشخوان">افزودن  دوره ی اعزام جدید</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="body">
                <form action="{{ route('add.periodplane') }}" id="form" method="post">
                    @csrf
                    <div class="form-group">
                        <input type="text" name="name" class="form-control" placeholder=" تاریخ اعزام  "
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('delete/periodplane/'.$plane->id) }}" type="button" class="btn btn-sm btn-default ac-btn-ui "
                                                    data-bs-toggle="tooltip"
